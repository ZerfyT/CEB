            ...
            <div class="row mt-2">
                <div class="customer-say col-sm-12 col-xl-4">
                    <div class="card-wrp">
                        ...
                        <div class="card-body">
                            <h6 class="lead card-text"><small>Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                    Quasi similique rem libero voluptate
                    ...
                    <div class="col-md-4">
                        <div class="ceb-details mt-3">
                            <div class="web d-flex">
                                <button type="button" class="btn btn-dark rounded-circle floating btn me-2"><i
                            ...
                            <div class="follow-icon d-flex mt-5 justify-content-center">
                                <div class="facebook">
                                    <a href="" class="btn btn-link floating btn"><img
                                            src="{{ asset('img/icon-img/facebook.png') }}" class="img-fluid" /></a>
                                </div>
                                <div class="youtube">
                                    <a href="" class="btn btn-link floating btn"><img
                                            src="{{ asset('img/icon-img/youtube.png') }}" class="img-fluid" /></a>
                                </div>
                                <div class="instagram">
                                    <a href="" class="btn btn-link floating btn"><img
                                            src="{{ asset('img/icon-img/instagram.png') }}" class="img-fluid" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
