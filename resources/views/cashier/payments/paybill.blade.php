...
@section('content')
    ...
    <div class="container w-50 bg-secondary p-4">
            ...
            <table class="table table-bordered border-white mt-5">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end"><input type="number" class="form-control p-1"></td>
                    </tr>
                    <tr>
        ...
        <div class="container d-flex justify-content-center">
            <button class="btn btn-danger" onclick="window.location.href='{{ route('payment-receipt') }}'" >Place Payment</button>
        </div>
    </div>
@endsection
